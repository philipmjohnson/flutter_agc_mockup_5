...
class _$GardenImpl implements _Garden {
  ...
  @override
  String toString() {
    return 'Garden(id: $id, name: $name, description: $description, imagePath: $imagePath, ownerID: $ownerID, chapterID: $chapterID, lastUpdate: $lastUpdate, editorIDs: $editorIDs, viewerIDs: $viewerIDs)';
  }
