...
/// Create a new Garden.
class AddGardenView2 extends ConsumerWidget {
  AddGardenView2({Key? key}) : super(key: key);

  static const routeName = '/addGardenView2';
  ...
  Widget _build(
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: const [HelpButton(routeName: AddGardenView2.routeName)],
        ),
        body: ListView(
